...
if __name__ == '__main__':
    df_disease = pd.read_excel(r'C:\HJH\circLocFeature\PsuedoKnc\7类/pseknc_features.xlsx', index_col=0)
    df_func = pd.read_excel('./../dataset/7类cell_similarity_gate.xlsx', header=None,index_col=0)
