...
# 保存AUC图
path = r'C:\HJH\plsm\code\temp'
os.makedirs(save_dir, exist_ok=True)
auc_pdf_path = os.path.join(path, f'repeat_{best_repeat}_AUC_curves.pdf')
auc_png_path = os.path.join(path, f'repeat_{best_repeat}_AUC_curves.png')
...
# 保存AUPR图
aupr_pdf_path = os.path.join(path, f'repeat_{best_repeat}_AUPR_curves.pdf')
aupr_png_path = os.path.join(path, f'repeat_{best_repeat}_AUPR_curves.png')
