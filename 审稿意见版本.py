...
if __name__ == '__main__':
    ...
    # df_RNAErnie_feature = pd.read_csv(r'C:\HJH\plsm\feature\rna_model_features_0.7_128_0.01.csv', header=None)
    ...
    # df_miloc_feature = pd.read_excel(r'C:\HJH\plsm\feature\circRNA_miRNA_loc_feature.xlsx', index_col=0)
    # df_kmer_feature = pd.read_excel(r'C:\HJH\circLocFeature\Kmer\7类\kmer.xlsx', header=None)
    # df_rckmer_feature = pd.read_excel(r'C:\HJH\circLocFeature\RCKmer\7类\rckmer.xlsx', header=None)
    ...
    save_dir = './best_model_repeat_change/'
